export const dom = (()=>{
    ...
    const paragraph = (name, unique, text)=>{
    ...
    const header = (level, value, ...[name, unique])=>{
    ...
    const form = ((action = "#", method = "#", name = "form")=>{ 
    ...
    const button = (name, unique, value)=> {
